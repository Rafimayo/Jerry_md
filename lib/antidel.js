...
const DeletedMedia = async (conn, mek, jid, deleteInfo) => {
    ...
    if (messageType === 'imageMessage' || messageType === 'videoMessage') {
        ...
        await conn.sendMessage(jid, { text: `*⚠️ 𝐀𝐋𝐄𝐑𝐓 𝐃𝐄𝐋𝐄𝐓𝐄𝐃 𝐅𝐈𝐋𝐄 𝐃𝐄𝐓𝐄𝐂𝐓𝐄𝐃 𝐁𝐘 𝐓𝐇𝐄 𝐉𝐄𝐑𝐑𝐘 𝐌𝐃 🚫⬅️!*\n\n${deleteInfo}` }, { quoted: mek });
    }
        ...
        if (update.update.message === null) {
            ...
            if (store && store.message) {
                ...
                if (isGroup) {
                    ...
                    deleteInfo = `*⚠️ 𝐀𝐋𝐄𝐑𝐓 𝐀𝐍𝐓𝐈𝐃𝐄𝐋𝐄𝐓𝐄 𝐃𝐄𝐓𝐄𝐂𝐓𝐄𝐃 𝐁𝐘 𝐓𝐇𝐄 𝐉𝐄𝐑𝐑𝐘-𝐌𝐃☠︎︎☠︎︎*\n\n*TIME:* ${deleteTime}\n*GROUP:* ${groupName}\n*DELETED BY:* @${deleter}\n*SENDER:* @${sender}`;
